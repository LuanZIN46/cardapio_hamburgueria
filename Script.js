...
const payWarn = document.getElementById("pay-warn");
...
checkoutBtn.addEventListener("click", function(){
    ...
    const phone = "14998580049"

    window.open(`https://wa.me/${phone}?text=${message} Endereço: ${addressInput.value} | Forma de Pagamento: ${payWarn.value}`, "_blank");
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (addressWarn && addressInput && checkoutBtn && payWarn) {
        checkoutBtn.addEventListener("click", function() {
            if (cart.length === 0) return;
